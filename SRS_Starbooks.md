...
|:---|:---|:---|:---|:---|:---|:---|:---|:---|:---|
|1|회원가입||
|1.1||사용자가 웹 서비스를 본격적으로 이용하기 위해 사용자가 되기 위한 절차이며, 회원가입을 하지 않아도 일부 기능을 제한적으로 열람할 수 있다.|
|1.1.1|||웹에 접속한 후 회원가입 버튼을 클릭하여 회원가입을 진행할 수 있다.|||||H|
|1.1.2|||필수 회원 정보를 입력한다.|||||H|
...
|2|로그인||
|2.1||웹을 사용하기 위해 회원가입 시 등록한 아이디와 비밀번호를 통해 로그인을 한다.|
|2.1.1|||사용자가 로그인 버튼을 클릭하면 시스템은 입력한 정보를 검증하고 로그인 성공 여부를 확인한다.|||||H|
|2.1.2|||사용자가 입력한 정보가 올바른 경우, 시스템은 사용자에게 웹의 첫 화면을 보여준다.|||||H|
|2.1.3|||사용자가 입력한 정보가 올바르지 않은 경우, 시스템은 오류 메시지를 표시한다.|||||H|
|3|로그아웃||
|3.1||시스템 접속이 필요 없어질 때 이용자가 로그아웃할 수 있으며 이후 다시 로그인할 수 있다.|
|3.1.1|||사용자는 로그아웃 버튼을 눌러 로그아웃을 진행할 수 있다.|||||H|
|3.1.2|||로그아웃이 성공하면, 사용자는 제한적으로 웹의 일부 기능을 열람만 할 수 있다.|||||H|
|4|프로필 설정||
|4.1||사용자는 마이페이지에서 개인 프로필을 설정할 수 있으며, 이를 통해 다른 사용자에게 자신의 정보를 공유할 수 있다.|
|4.1.1|||프로필 설정 페이지에서 자신의 닉네임을 수정할 수 있다.|||||H|
|4.1.2|||수정된 닉네임이 이미 존재하는 경우, 오류 메시지를 표시한다.|||||H|
